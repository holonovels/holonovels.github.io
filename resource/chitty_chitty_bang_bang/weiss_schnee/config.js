...
var PMX_FILE = { name: 'RWBYワイズ・シュニー', file: '../../assets/models/weiss_schnee/weiss_schnee.pmx', emissive: 0.3, multiply: 0.0739, physics: true, receiveShadow: true, thickness: 0.001 };
//const PMX_FILE = { name: 'ロボ子さん', file: '../../assets/models/weiss_schnee/weiss_schnee.pmx', emissive: 0.6, multiply: 0.0739, physics: true, receiveShadow: true, thickness: 0.002 };
// 読み込むモーションファイル(VMDファイル)をオブジェクトで管理する
var VMD_FILE = { name: 'チキチキバンバン', file: '../../assets/motions/chitty_chitty_bang_bang_sing.vmd' };
var filename = 'chitty_chitty_bang_bang_sing_weiss_schnee';
var ragtime = 1.1;
