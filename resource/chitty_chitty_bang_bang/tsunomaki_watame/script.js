...
function onPlayerReady() {
	// 2番は飛ばす。
	function updateTime() {
		if(player.getCurrentTime() >= video_jump_from && player.getCurrentTime() < video_jump_to) {
			player.seekTo(video_jump_to, true);
		}
	}
